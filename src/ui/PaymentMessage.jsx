  ...
  return (
    <div className="  flex flex-col justify-center items-center gap-y-24 lg:gap-y-32">
      ...
      <div className=" flex justify-center items-center">
        <button
          onClick={backToUrlBeforeCheckout}
          className=" font-semibold py-2 lg:py-4 px-6 lg:px-8 rounded-xl text-white bg-black transition-transform lg:hover:scale-95"
        >
