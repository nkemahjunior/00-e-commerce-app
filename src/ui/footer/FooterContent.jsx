...
export default function FooterContent() {
    ...
    const fakeSubscribe = () => {
        if (email.length > 1) toast.success("subscribed")
        else toast.error("enter email");
    }
    ...
    return (
      <div className="mt-8">
        <div
          className="bg-black px-3 rounded-md w-[95dvw]   py-4 space-y-3 
          ...
          <div className="space-y-4">
            <div className="bg-white flex items-center h-fit rounded-lg px-4 py-1 ">
              ...
              <input
                ...
                className=" outline-none w-full h-fit ml-4"
                value={email}
            ...
            <button
              className="bg-white rounded-lg text-center py-1 w-full text-black font-semibold  lg:hover:scale-95"
          ...
          <div className="">
            <div className="md:grid md:grid-cols-[30fr,70fr] md:gap-x-2 xl:gap-x-4 2xl:gap-x-6">
              <div className="lg:mr-8 xl:mr-16 2xl:mr-20">
                ...
                <div className=" font-light">
                  Get all trending and classic clothes at affordable prices for
                  children, men and women.Delivery right at your door steps{" "}
                </div>
              ...
              <div className=" grid grid-cols-2 gap-4 md:grid-cols-4">
                ...
                <div>
                  ...
                  <div className=" font-light capitalize mb-1">
                    customer support
                  </div>
            ...
            <div className="flex flex-col space-y-2 md:flex-row md:justify-between md:items-center">
              <div className="capitalize font-light">
                zeco shopping&copy; 1929-{year}. All Rights Reserved
              </div>
