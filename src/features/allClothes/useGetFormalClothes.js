...
export function useGetFormalClothes(){
    ...
    const {isLoading,data:{data,count,error}={}} = useQuery({
        ...
        queryKey:['formal',curPage,sortBy,startPriceRange,priceRange1,priceRange2,priceRange],

        queryFn:() =>  getFormalClothes({curPage,sortBy,startPriceRange,priceRange1,priceRange2})
    });
