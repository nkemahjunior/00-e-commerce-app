  ...
  return (
    <div className="px-2 md:pl-4 md:flex justify-center">
      <form id="FormAddDress" onSubmit={submitForm} className="space-y-3">
        ...
        <button
          className={` flex items-center justify-center  p-2 border-2 border-solid border-black w-full  text-white  font-bold lg:hover:scale-95 ${loading ? "bg-[#373737]" : "bg-black"}`}
          type="submit"
