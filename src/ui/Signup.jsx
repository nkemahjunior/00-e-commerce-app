                ...
                <div className='h-fit w-full md:w-[50%] flex flex-col justify-center items-center py-4 px-1 space-y-4'>
                    ...
                    <form action="auth/sign-up" className=' w-full md:w-[80%] space-y-4' onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div className='flex justify-center '>
                            <button className={` capitalize bg-black text-white text-center p-2 w-[60%] rounded-md lg:hover:scale-95 flex justify-center items-center space-x-2  ${isLoading ? 'bg-[#373737]' : 'bg-black'}`}
                            disabled={isLoading}>
