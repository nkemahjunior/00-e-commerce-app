        ...
        <div className="h-fit w-full  flex flex-col justify-center items-center py-4 px-1 space-y-4">
          ...
          >
            ...
            <div className="flex justify-center ">
              <button
                className={`capitalize  text-white text-center p-2 w-[60%] rounded-md lg:hover:scale-95 flex justify-center items-center space-x-2 ${isLoading ? "bg-[#373737]" : "bg-black"}`}
                disabled={isLoading}
              >
                Login{" "}
                {isLoading && (
