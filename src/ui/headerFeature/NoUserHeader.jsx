        ...
        <nav className="sticky top-0 z-20">
          ...
          >
            ...
            <div className="flex space-x-4">
              <button className="capitalize p-2 font-semibold text-black bg-white rounded-lg  border-2 border-solid border-black lg:hover:bg-[#DBDBDB] transition-all">sign up</button>

              <button className="capitalize p-2 font-semibold text-white bg-black rounded-lg  border-2 border-solid border-black lg:hover:bg-[#373737] transition-all">sign in</button>
            </div>
