...
function ShoppingBag() {
    ...
    const itemsInCartLength = useSelector((state) => state.showCart.numberOfItemsInCart)
    ...
    return (
        ...
        {   
            ...
            itemsInCartLength === 0 ? <div className="flex justify-center items-center  h-screen w-full"> no items in shopping bag... </div> :
        
            <div className="px-2  md:px-[2rem] lg:px-[3rem] xl:px-[4rem] 2xl:px-[6rem] space-y-4">
                
                <h1 className=" text-2xl uppercase font-semibold mt-2">shopping bag</h1>
                ...
                flex flex-col  md:flex-row
                  space-y-2 md:space-x-4 ">
                    ...
                    border-2 border-solid border-stone-200 h-fit p-2">
                        {
                            itemsInCart.map((el,i) => <ShoppingBagItem data={el} price={el.price} fetchId={i} key={Math.random()}/>)
                    ...
                    border-2 border-solid border-stone-200 p-2 h-fit  ">
                        ...
                        <ul className="space-y-2 md:space-y-4">
                            ...
                            <div  className="flex justify-between">
                                <li className="capitalize mt-2 text-stone-600">estimated total</li>
